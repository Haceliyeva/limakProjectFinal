...
const Pazarium = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Pazarium');
    ...
    return (
        <div>
            ...
            <img src="https://limakaz.s3.eu-west-2.amazonaws.com/public/shops/720.png" alt="img" />  
            </h1>
