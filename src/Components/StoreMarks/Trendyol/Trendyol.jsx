...
const Trendyol = () => {
    ...
    useEffect(() => {
        const fetchNotes = async () => {
            try {
                ...
                const filteredNotes = res.data.allNotes.filter(note => note.catagory === 'Trendyol');
    ...
    return (
        <div>
            ...
            <img src="https://limakaz.s3.eu-west-2.amazonaws.com/public/shops/255.png" alt="img" /> 
            </h1>
